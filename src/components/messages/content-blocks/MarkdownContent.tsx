  ...
  return (
    <div className="text-sm text-foreground space-y-3">
      <ReactMarkdown
        ...
        // Other elements
        blockquote: ({ children }) => (
          <blockquote className="border-l-4 border-secondary pl-4 italic my-3">{children}</blockquote>
        ),
        a: ({ href, children }) => (
        ...
        th: ({ children }) => <th className="border border-border px-3 py-2 text-left bg-secondary font-bold">{children}</th>,
